...
//Structure corps du garbage
typedef struct s_gc_controller
{
	int			alloc_nb;
	t_gc		*start;
	bool		debug;
...
//GARBAGE COLLECTOR
void		*gc_malloc(t_gc_controller	**gc_control,
				unsigned int size, int type, char *tag);
