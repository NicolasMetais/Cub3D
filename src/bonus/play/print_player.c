...
/*   Updated: 2025/06/23 20:55:42 by tvacher          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	loop_render_rays(t_core *core, int color)
{
	int	px_index;
...
void	print_rays(t_core *core, int color)
{
	...
	while (i < (int)core->rc->dist3[core->rc->r] + 2 && i < \
	core->rc->map_size / 2)
	{
