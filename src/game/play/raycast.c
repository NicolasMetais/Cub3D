...
static void get_good_dist(t_core *core)
{
	if (core->tmp_rc->dist[core->tmp_rc->r] > core->tmp_rc->dist2[core->tmp_rc->r])
	{
		...
		core->tmp_rc->hit_wall = core->tmp_rc->v_wall;
		core->tmp_rc->door_x = core->tmp_rc->v_door_x;
		core->tmp_rc->door_y = core->tmp_rc->v_door_y;
		core->tmp_rc->door_dist = core->tmp_rc->v_door_dist;
	}
	else
	{
		...
		core->tmp_rc->hit_wall = core->tmp_rc->h_wall;
		core->tmp_rc->door_x = core->tmp_rc->h_door_x;
		core->tmp_rc->door_y = core->tmp_rc->h_door_y;
		core->tmp_rc->door_dist = core->tmp_rc->h_door_dist;

	}
	if (core->tmp_rc->r == core->tmp_rc->max_r / 2)
	{
		core->tmp_rc->front_wall = core->tmp_rc->hit_wall;
		core->tmp_rc->front_x = (int)core->tmp_rc->rx / 8;
		core->tmp_rc->front_y = (int)core->tmp_rc->ry / 8;
	}
}
...
void	get_raycast_data(t_core *core)
{
	...
	while (core->tmp_rc->r < core->tmp_rc->max_r)
	{
		...
		core->tmp_rc->h_door_dist[core->tmp_rc->r] = sqrt((core->tmp_rc->h_door_x - core->tmp_rc->pl_x) * (core->tmp_rc->h_door_x - core->tmp_rc->pl_x) + \
		(core->tmp_rc->h_door_y - core->tmp_rc->pl_y) * (core->tmp_rc->h_door_y - core->tmp_rc->pl_y));
		vertical_cast(core);
		core->tmp_rc->dist2[core->tmp_rc->r] = sqrt((core->tmp_rc->rx - core->tmp_rc->pl_x) * (core->tmp_rc->rx - core->tmp_rc->pl_x) + \
		(core->tmp_rc->ry - core->tmp_rc->pl_y) * (core->tmp_rc->ry - core->tmp_rc->pl_y));
		core->tmp_rc->v_door_dist[core->tmp_rc->r] = sqrt((core->tmp_rc->v_door_x - core->tmp_rc->pl_x) * (core->tmp_rc->v_door_x - core->tmp_rc->pl_x) + \
		(core->tmp_rc->v_door_y - core->tmp_rc->pl_y) * (core->tmp_rc->v_door_y - core->tmp_rc->pl_y));
		get_good_dist(core);
		...
		core->tmp_rc->door_dist[core->tmp_rc->r] = core->tmp_rc->dist3[core->tmp_rc->r] * (cos(core->tmp_rc->ca));
		draw_3d(core);
		rays_updates(core);
	}
}
...
void	get_rc_data(t_core *core)
{
	...
	core->tmp_rc->door_dist = gc_malloc(&core->gc, sizeof(float) * core->tmp_rc->max_r, FLOAT, "door_dist");
	core->tmp_rc->h_door_dist = gc_malloc(&core->gc, sizeof(float) * core->tmp_rc->max_r, FLOAT, "h_door_dist");
	core->tmp_rc->v_door_dist = gc_malloc(&core->gc, sizeof(float) * core->tmp_rc->max_r, FLOAT, "v_door_dist");
	if (!core->tmp_rc->dist || !core->tmp_rc->dist2 || !core->tmp_rc->dist3 || \
		!core->tmp_rc->door_dist || !core->tmp_rc->h_door_dist || !core->tmp_rc->v_door_dist)
		return ;
}
