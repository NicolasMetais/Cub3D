...
/*   Updated: 2025/06/03 16:45:43 by nmetais          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void handle_straf_right(t_core *core, double move_dist)
{
	...
	core->r_straff->next_x = core->rc->pl_x - core->r_straff->straf_x * move_dist;
	core->r_straff->next_y = core->rc->pl_y - core->r_straff->straf_y * move_dist;
...
static void handle_straf_left(t_core *core, double move_dist)
{
	...
	core->l_straff->next_x = core->rc->pl_x - core->l_straff->straf_x * move_dist;
	core->l_straff->next_y = core->rc->pl_y - core->l_straff->straf_y * move_dist;
