...
void	get_draw_loop_data(t_core *core)
{
	...
	if ((int)core->rc3d->ty >= core->textures->tmp_east->height)
		core->rc3d->ty = core->textures->tmp_east->height - 1;
}
...
void	get_draw_start_data(t_core *core)
{
	...
	if (core->rc3d->tx < 0)
		core->rc3d->tx = 0;
	if (core->rc3d->tx >= core->textures->tmp_east->width)
		core->rc3d->tx = core->textures->tmp_east->width - 1;
...
void	get_3d_based_data(t_core *core)
{
	...
	core->rc3d->step = (float)core->textures->tmp_east->height / \
